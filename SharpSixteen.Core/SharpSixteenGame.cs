...
namespace SharpSixteen.Core
{
    ...
    /// </remarks>}
    public class SharpSixteenGame : Game
    {
        ...
        private SettingsManager<SharpSixteenSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<SharpSixteenLeaderboard> leaderboardManager;
        ...
        public SharpSixteenGame()
        {
            ...
            settingsManager = new SettingsManager<SharpSixteenSettings>(storage);
            Services.AddService(typeof(SettingsManager<SharpSixteenSettings>), settingsManager);
            ...
            // 16-bit JRPG style: 320x240 logical resolution (SNES-like), scales to window.
            screenManager.BaseScreenSize = new Vector2(320, 240);
